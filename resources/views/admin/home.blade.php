...
<html lang="en">
  <head>
    ...
    <!-- plugins:css -->
    <link rel="stylesheet" href="{{asset('/')}}backend-asset/css/materialdesignicons.min.css">
    <link rel="stylesheet" href="{{asset('/')}}backend-asset/css/vendor.bundle.base.css">
    <!-- endinject -->
  ...
  <body>
    ...
    <!-- container-scroller -->
    <!-- plugins:js -->
    <script src="{{asset('/')}}backend-asset/vendors/js/vendor.bundle.base.js"></script>
    <!-- endinject -->
    ...
    <script src="{{asset('/')}}backend-asset/js/jquery.cookie.js" type="text/javascript"></script>
